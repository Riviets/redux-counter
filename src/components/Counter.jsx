    ...
    return(
        <div className="flex items-center justify-center min-h-screen bg-gray-700">
            <div className="flex flex-col items-center gap-5 bg-white p-8 border-2 shadow-md rounded-md border-gray-600">
                <p className="font-bold text-5xl border-2 w-full text-center py-1 px-3 rounded-sm border-gray-500">{value}</p>
                ...
                <div className="flex flex-col gap-3 mb-6">
                    <div className="flex gap-4 items-end">
                       <div className="flex flex-col gap-1">
                            ...
                            <input type="number" min={0} id="incrementBy" name="incrementBy" value={inputValues?.incrementBy}onChange={handleChange} className="border-2 rounded-md px-3 py-1 text-xl max-w-[250px]"/>
                       </div>
                    ...
                    <div className="flex gap-4 items-end">
                       <div className="flex flex-col gap-1">
                            ...
                            <input type="number" min={0} id="decrementBy" name="decrementBy" value={inputValues?.decrementBy} onChange={handleChange} className="border-2 rounded-md px-3 py-1 text-xl max-w-[250px]"/>
                       </div>
                        <button onClick={()=>{dispatch(decrementBy(Number(inputValues.decrementBy)))}} className="bg-gray-600 text-white font-bold text-xl py-1 px-4 rounded-md border-2 border-gray-700">OK</button>
                    </div>
                </div>
